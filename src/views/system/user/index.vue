    ...
    methods: {
        ...
        handleResetPwd (row) {
            this.$prompt('请输入"' + row.userName + '"的新密码', "提示", {
                ...
                const uuid = 'ea50fb62166a4ee6b05748a3d1179ec4'
                var password = ''
                password = rsa.codeEncrypt(
                    value,
                    uuid
                )
            ...
            this.$refs["form"].validate(valid => {
                if (valid) {
                    ...
                    if (this.form.userId != undefined) {
                        ...
                        // 密码加密
                        const uuid = 'ea50fb62166a4ee6b05748a3d1179ec4'
                        parmas.password = rsa.codeEncrypt(
                            parmas.password,
                            uuid
                        )
                        addUser(parmas).then(response => {
        ...
        importTemplate () {
            ...
            }, `用户模板_${new Date().getTime()}.xlsx`)*/
            var fileName = "Template_用户模板.xlsx";
            var isDelete = false;
            download.downFile(
                fileName,
                isDelete
